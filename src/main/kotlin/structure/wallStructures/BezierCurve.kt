...
/**
 * A Beziercurve with 2 control Points.
 * Check this out to get a feel for it:
 * https://www.desmos.com/calculator/cahqdxeshd
 */
open class BezierCurve : WallStructure(), WallPath {
    /** the Starting Point of the Curve */
    var p0: Vec2 = Vec2()
    /** the first ControlPoint of the Curve. Imagine stretching it in Gimp. */
    var p1: Vec2 = Vec2()
    /** the second ControlPoint of the Curve. Imagine stretching it in Gimp. */
    var p2: Vec2 = Vec2()
    ...
    override fun createWalls(): List<BwObstacle> {
        ...
        val t2 = p2.toVec3(duration*2.0/3.0)
        val t3 = p3.toVec3(duration)
